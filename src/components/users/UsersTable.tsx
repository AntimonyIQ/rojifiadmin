        ...
        <CardHeader className="px-6 py-5 border-b border-gray-200">
          ...
          <div className="flex flex-wrap items-center gap-2 mt-4 border-t border-gray-100 pt-4">
            ...
            <Badge 
              ...
              className={`cursor-pointer hover:bg-primary/90 transition-all ${statusFilter === "" ? "bg-primary text-white" : "text-gray-600 hover:text-white"}`}
                  ...
                  paginatedUsers.map((user) => (
                    <TableRow key={user.id}>
                      ...
                      <TableCell className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className={`h-8 w-8 rounded-full flex items-center justify-center font-medium ${getAvatarColor(user.name)}`}>
                      ...
                      <TableCell className="px-6 py-4 whitespace-nowrap">
                        <Badge className={`font-medium ${getStatusColor(user.status)}`}>
                          {user.status}
                        </Badge>
                      </TableCell>
                      <TableCell className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
