...
export default function ConfigureCurrencyForm() {
  ...
  const [newCurrencyMaxSwapAmount, setNewCurrencyMaxSwapAmount] = useState(10000);
  const [newCurrencyMinTransferAmount, setNewCurrencyMinTransferAmount] = useState(1);
  const [newCurrencyMaxTransferAmount, setNewCurrencyMaxTransferAmount] = useState(100000);
  ...
  const [editCurrencyMinSwapAmount, setEditCurrencyMinSwapAmount] = useState(10);
  const [editCurrencyMaxSwapAmount, setEditCurrencyMaxSwapAmount] = useState(10000);
  const [editCurrencyMinTransferAmount, setEditCurrencyMinTransferAmount] = useState(1);
  const [editCurrencyMaxTransferAmount, setEditCurrencyMaxTransferAmount] = useState(100000);
  const [editCurrencyIsBaseCurrency, setEditCurrencyIsBaseCurrency] = useState(false);
  ...
  const handleAddNewCurrency = () => {
    ...
    // Add the new currency to the form
    form.setValue("currencies", [
      ...currentCurrencies,
      {
        ...
        countryCode: newCurrencyCountryCode,
        decimalPlaces: newCurrencyDecimalPlaces,
        minSwapAmount: newCurrencyMinSwapAmount,
        maxSwapAmount: newCurrencyMaxSwapAmount,
        minTransferAmount: newCurrencyMinTransferAmount,
        maxTransferAmount: newCurrencyMaxTransferAmount,
        image: newCurrencyImage,
        isBaseCurrency: false,
        isEnabled: true,
      }
    ]);
    ...
    toast({
      ...
      description: `${newCurrencyName} (${newCurrencyCode}) has been added successfully.`,
    });
  };
  
  const handleEditCurrency = (currency: any, index: number) => {
    ...
    setEditCurrencyCountryCode(currency.countryCode);
    setEditCurrencyImage(currency.image || "");
    setEditCurrencyDecimalPlaces(currency.decimalPlaces);
    setEditCurrencyMinSwapAmount(currency.minSwapAmount);
    setEditCurrencyMaxSwapAmount(currency.maxSwapAmount);
    setEditCurrencyMinTransferAmount(currency.minTransferAmount);
    setEditCurrencyMaxTransferAmount(currency.maxTransferAmount);
  ...
  const handleSaveEditedCurrency = () => {
    if (editingCurrencyIndex === null) return;
    
    const currentCurrencies = [...form.getValues().currencies];
    
    // Update the currency at the specified index
    currentCurrencies[editingCurrencyIndex] = {
      code: editCurrencyCode,
      name: editCurrencyName,
      symbol: editCurrencySymbol,
      exchangeRate: editCurrencyExchangeRate,
      country: editCurrencyCountry,
      countryCode: editCurrencyCountryCode,
      decimalPlaces: editCurrencyDecimalPlaces,
      minSwapAmount: editCurrencyMinSwapAmount,
      maxSwapAmount: editCurrencyMaxSwapAmount,
      minTransferAmount: editCurrencyMinTransferAmount,
      maxTransferAmount: editCurrencyMaxTransferAmount,
      image: editCurrencyImage,
      isBaseCurrency: editCurrencyIsBaseCurrency, // Preserve base currency status
      isEnabled: editCurrencyIsEnabled,
    };
    
    // Update the form state
    form.setValue("currencies", currentCurrencies);
    ...
    toast({
      ...
      description: `${editCurrencyName} (${editCurrencyCode}) has been updated successfully.`,
    });
  };
  ...
  const handleDeleteCurrency = () => {
    ...
    const currencyToDelete = currentCurrencies.find(c => c.code === deleteCurrencyCode);
    ...
    // Remove the currency
    const filteredCurrencies = currentCurrencies.filter(c => c.code !== deleteCurrencyCode);
    form.setValue("currencies", filteredCurrencies);
    ...
    toast({
      ...
      description: `${currencyToDelete?.name} (${deleteCurrencyCode}) has been removed successfully.`,
    });
  };
        ...
        <CardContent className="space-y-8 px-6 py-6">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl font-medium text-gray-900">Currency Configuration</h3>
                <p className="text-sm text-gray-500 mt-1">
                  Configure currencies, exchange rates, and base currency for your application.
                </p>
              </div>
            ...
            <Dialog open={editCurrencyDialogOpen} onOpenChange={setEditCurrencyDialogOpen}>
              <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                  <DialogTitle>Edit Currency</DialogTitle>
                  <DialogDescription>
                    Update the currency details. Some fields may be read-only for system currencies.
                  </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-6 py-4 max-h-[70vh] overflow-y-auto pr-2">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-3">
                      <Label htmlFor="edit-currency-code" className="text-sm font-medium text-gray-700">
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="edit-currency-name" className="text-sm font-medium text-gray-700">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-3">
                      <Label htmlFor="edit-currency-symbol" className="text-sm font-medium text-gray-700">
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="edit-exchange-rate" className="text-sm font-medium text-gray-700">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setEditCurrencyExchangeRate(parseFloat(e.target.value))}
                        className="w-full"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="edit-country-code" className="text-sm font-medium text-gray-700">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setEditCurrencyCountryCode(e.target.value.toUpperCase())}
                        className="w-full"
                        maxLength={2}
                      />
                    </div>
                  ...
                  <div className="space-y-3">
                    <Label htmlFor="edit-decimal-places" className="text-sm font-medium text-gray-700">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setEditCurrencyDecimalPlaces(parseInt(e.target.value))}
                      className="w-full"
                    />
                    <p className="text-xs text-gray-500">
                  ...
                  <div className="border-t border-gray-100 pt-4 mt-2">
                    <h4 className="text-sm font-medium text-gray-800 mb-3">Transaction Limits</h4>
                    
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-3">
                        <Label htmlFor="edit-min-swap" className="text-sm font-medium text-gray-700">
                        ...
                        <Input 
                          ...
                          onChange={(e) => setEditCurrencyMinSwapAmount(parseFloat(e.target.value))}
                          className="w-full"
                        />
                      </div>
                      
                      <div className="space-y-3">
                        <Label htmlFor="edit-max-swap" className="text-sm font-medium text-gray-700">
                        ...
                        <Input 
                          ...
                          onChange={(e) => setEditCurrencyMaxSwapAmount(parseFloat(e.target.value))}
                          className="w-full"
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-4">
                      <div className="space-y-3">
                        <Label htmlFor="edit-min-transfer" className="text-sm font-medium text-gray-700">
                          Min Transfer Amount <span className="text-red-500">*</span>
                        </Label>
                        <Input 
                          ...
                          onChange={(e) => setEditCurrencyMinTransferAmount(parseFloat(e.target.value))}
                          className="w-full"
                        />
                      </div>
                      
                      <div className="space-y-3">
                        <Label htmlFor="edit-max-transfer" className="text-sm font-medium text-gray-700">
                          Max Transfer Amount <span className="text-red-500">*</span>
                        </Label>
                        <Input 
                          ...
                          onChange={(e) => setEditCurrencyMaxTransferAmount(parseFloat(e.target.value))}
                          className="w-full"
                        />
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    <Label htmlFor="edit-currency-image" className="text-sm font-medium text-gray-700">
                      Currency Image URL
                    </Label>
                    <Input 
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor="edit-currency-enabled" className="text-sm font-medium text-gray-700">
                        Enabled
                      </Label>
                    </div>
                    <p className="text-xs text-gray-500">
                ...
                <DialogFooter>
                  ...
                  <Button 
                    ...
                    disabled={
                      ...
                      !editCurrencyName || 
                      !editCurrencySymbol || 
                      (!editCurrencyIsBaseCurrency && editCurrencyExchangeRate <= 0) ||
                      !editCurrencyCountry ||
                      !editCurrencyCountryCode ||
                      editCurrencyDecimalPlaces < 0 ||
                      editCurrencyMinSwapAmount < 0 ||
                      editCurrencyMaxSwapAmount <= 0 ||
                      editCurrencyMinTransferAmount < 0 ||
                      editCurrencyMaxTransferAmount <= 0 ||
                      editCurrencyMinSwapAmount >= editCurrencyMaxSwapAmount ||
                      editCurrencyMinTransferAmount >= editCurrencyMaxTransferAmount
                    }
                  >
                    Save Changes
                  </Button>
            ...
            <Dialog open={!!deleteCurrencyCode} onOpenChange={(open) => !open && setDeleteCurrencyCode(null)}>
              <DialogContent className="sm:max-w-[400px]">
                ...
                <div className="py-4">
                  <p className="text-sm text-gray-500">
                    Deleting this currency will remove it from your system and all related settings. Active transactions will not be affected.
                  </p>
                </div>
            ...
            <div className="flex justify-end">
              <Dialog open={newCurrencyDialogOpen} onOpenChange={setNewCurrencyDialogOpen}>
                ...
                <DialogContent className="sm:max-w-[500px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Enter the details for the new currency. Exchange rate should be relative to your base currency.
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  <div className="space-y-6 py-4 max-h-[70vh] overflow-y-auto pr-2">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-3">
                        <Label htmlFor="currency-code" className="text-sm font-medium text-gray-700">
                          Currency Code <span className="text-red-500">*</span>
                        </Label>
                        <Input 
                          id="currency-code" 
                      ...
                      <div className="space-y-3">
                        <Label htmlFor="currency-name" className="text-sm font-medium text-gray-700">
                          Currency Name <span className="text-red-500">*</span>
                        </Label>
                        <Input 
                          id="currency-name" 
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-3">
                        <Label htmlFor="currency-symbol" className="text-sm font-medium text-gray-700">
                          Currency Symbol <span className="text-red-500">*</span>
                        </Label>
                        <Input 
                          id="currency-symbol" 
                      ...
                      <div className="space-y-3">
                        <Label htmlFor="exchange-rate" className="text-sm font-medium text-gray-700">
                          Exchange Rate <span className="text-red-500">*</span>
                        </Label>
                        <Input 
                          id="exchange-rate" 
                          ...
                          onChange={(e) => setNewCurrencyExchangeRate(parseFloat(e.target.value))}
                          className="w-full"
                        />
                        <p className="text-xs text-gray-500">
                          Relative to {form.watch("baseCurrency")}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <Input 
                          ...
                          onChange={(e) => setNewCurrencyCountryCode(e.target.value.toUpperCase())}
                          className="w-full"
                          maxLength={2}
                        />
                      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setNewCurrencyDecimalPlaces(parseInt(e.target.value))}
                        className="w-full"
                      />
                      <p className="text-xs text-gray-500">
                        Number of decimal places to display (0-8)
                    ...
                    <div className="border-t border-gray-100 pt-4 mt-2">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-3">
                          <Label htmlFor="min-swap" className="text-sm font-medium text-gray-700">
                            Min Swap Amount <span className="text-red-500">*</span>
                          </Label>
                          <Input 
                            id="min-swap" 
                            ...
                            onChange={(e) => setNewCurrencyMinSwapAmount(parseFloat(e.target.value))}
                            className="w-full"
                          />
                        </div>
                        
                        <div className="space-y-3">
                          <Label htmlFor="max-swap" className="text-sm font-medium text-gray-700">
                            Max Swap Amount <span className="text-red-500">*</span>
                          </Label>
                          <Input 
                            id="max-swap" 
                            ...
                            onChange={(e) => setNewCurrencyMaxSwapAmount(parseFloat(e.target.value))}
                            className="w-full"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 mt-4">
                        <div className="space-y-3">
                          <Label htmlFor="min-transfer" className="text-sm font-medium text-gray-700">
                            Min Transfer Amount <span className="text-red-500">*</span>
                          </Label>
                          <Input 
                            id="min-transfer" 
                            ...
                            onChange={(e) => setNewCurrencyMinTransferAmount(parseFloat(e.target.value))}
                            className="w-full"
                          />
                        </div>
                        
                        <div className="space-y-3">
                          <Label htmlFor="max-transfer" className="text-sm font-medium text-gray-700">
                            Max Transfer Amount <span className="text-red-500">*</span>
                          </Label>
                          <Input 
                            id="max-transfer" 
                            ...
                            onChange={(e) => setNewCurrencyMaxTransferAmount(parseFloat(e.target.value))}
                            className="w-full"
                          />
                        </div>
                      </div>
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="currency-image" className="text-sm font-medium text-gray-700">
                        Currency Image URL
                      </Label>
                      <Input 
                        id="currency-image" 
                  ...
                  <DialogFooter>
                    ...
                    <Button 
                      ...
                      disabled={
                        ...
                        newCurrencyMinTransferAmount >= newCurrencyMaxTransferAmount
                      }
                    >
                      Add Currency
                    </Button>
          ...
          <div className="border rounded-md overflow-hidden">
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {form.watch("currencies").map((currency, index) => (
                        ...
                        {currency.image ? (
                          <div className="h-8 w-8 rounded-full overflow-hidden mr-3 border border-gray-200 flex-shrink-0">
                            <img 
                              ...
                              onError={(e) => {
                                // If image fails to load, show fallback with code
                                (e.target as HTMLImageElement).style.display = 'none';
                                e.currentTarget.parentElement!.classList.add('bg-blue-50', 'text-blue-700');
                                e.currentTarget.parentElement!.innerHTML = `<span class="font-medium">${currency.code}</span>`;
                              }}
                            />
                          </div>
                        ) : (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex space-x-2 justify-end">
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleEditCurrency(currency, index)}
                        ...
                        {!currency.isBaseCurrency && (
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => setDeleteCurrencyCode(currency.code)}
          ...
          <div className="bg-blue-50 p-4 rounded-md">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="text-sm font-medium text-blue-800">Currency Exchange Information</h4>
                <p className="text-sm text-blue-600 mt-1">
                  The base currency ({form.watch("baseCurrency")}) is used as the reference for all exchange rates.
                  When setting a new currency, the exchange rate should represent how many units of the base currency
                  equal one unit of the new currency.
                </p>
              </div>
            </div>
          </div>
